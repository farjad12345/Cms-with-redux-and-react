...
import { getCoursessByServer } from "../../Redux/store/courses";
...
export default function Courses() {
  ...
  useEffect(() => {
   dispatch(getCoursessByServer('https://redux-cms.iran.liara.run/api/courses'))
  },[]);
    ...
    <div className="col-8 content px-0">
      <div className="content__wrapper d-flex flex-column align-content-between">
        ...
        <div className="products products-container">
          ...
          { courses.map(cours=>  <CourseBox key={cours._id} {...cours} />
        )}   
